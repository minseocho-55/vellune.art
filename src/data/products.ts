...
export const collections: Collection[] = [
  {
    ...
    origin: 'Madagascar',
    occasion:
      'An impeccable choice for milestone occasions — promotions, anniversaries, and first meetings where lasting impressions are the only currency that matters.',
    featured: true,
  },
  {
    id: 'champagne-rose',
    ...
    origin: 'Belgium',
    occasion:
      'Ideal for intimate celebrations: birthdays, engagements, and expressions of devotion. The most romantic piece in the Vellune collection.',
    featured: false,
  },
  {
    id: 'burnished-copper',
    ...
    origin: 'Colombia',
    occasion:
      'For the collector and the connoisseur. A considered gift for the host who understands that the finest evening deserves the finest finish.',
    featured: false,
  },
  {
    id: 'royal-amethyst',
    ...
    origin: 'Ecuador',
    occasion:
      'A ceremonial gift for moments of singular importance — weddings, farewells, and gestures that must be remembered long after the occasion.',
    featured: false,
  },
  {
    id: 'emerald-mint',
    ...
    origin: 'Venezuela',
    occasion:
      'For those who prefer the unexpected. An ideal gift for the discerning guest who has, perhaps, experienced everything else.',
    featured: false,
  },
  {
    id: 'dark-onyx',
    ...
    origin: 'Peru',
    occasion:
      'A gift for the purist. For the person who needs nothing more than the absolute.',
    featured: false,
  },
]
