...
const reveal = {
  ...
  visible: (i: number) => ({
    opacity: 1, y: 0,
    transition: { duration: 1.1, delay: i * 0.13, ease: [0.22, 1, 0.36, 1] },
  }),
}
  ...
  return (
    <section id="about" className="relative section-y bg-noir overflow-hidden">
      ...
      <div ref={ref} className="relative container-maison text-center">
        ...
        {/* Moon divider */}
        <motion.div
          custom={2} variants={reveal} initial="hidden" animate={inView ? 'visible' : 'hidden'}
          className="mb-12"
        >
        ...
        {/* Body paragraph */}
        <motion.p
          custom={3} variants={reveal} initial="hidden" animate={inView ? 'visible' : 'hidden'}
        ...
        <motion.p
          custom={4} variants={reveal} initial="hidden" animate={inView ? 'visible' : 'hidden'}
