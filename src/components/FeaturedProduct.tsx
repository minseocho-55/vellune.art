        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          >
            ...
            >
              ...
              <p className="font-montserrat text-[10px] tracking-[0.28em] uppercase" style={{ color: 'rgba(240,232,216,0.6)' }}>
                {featured.pieces} pcs · {featured.weight} · {featured.origin}
              </p>
            </div>
          </motion.div>
          ...
          <div className="lg:pl-8 xl:pl-14 relative">
            ...
            >
              ...
              {/* Tasting notes */}
              <motion.div custom={5} variants={reveal} className="mb-10">
              ...
              {/* Price + CTA */}
              <motion.div custom={6} variants={reveal} className="flex items-center gap-8 flex-wrap">
